...
<img style="float: right;" src="img/Fundulus_phylogeny.png" width="500px">
...
These are Ruta's pulse field gels showing samples that were sequenced (in order from left to right: *F. catenatus*, *F. olivaceus*, *F. nottii*, *A. xenica*). Fresh tissues were extract from *A. xenica*, *F. nottii*. Frozen tissue from *F. catenatus* and *F. olivaceus*.

<img src="img/four_gels.png" width="700px">
