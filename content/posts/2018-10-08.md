...
<img src="img/ruta_promethion.png" width="400px">
...
The *Fundulus heteroclitus* killifish has been well-studied because of its physiological resilience to environmental change. It has also been found to have [rapidly evolved to polluted environments](http://science.sciencemag.org/content/354/6317/1305). *F. heteroclitus* is also a flexible model for resilience to salinity change. While *F. heteroclitus* is capable of osmoregulating in a wide range of salinities, some of its sister species are not.
...
<img src="img/fishsamples.png" width="200px">

* [Ultra-long read sequencing protocol by Josh Quick and Nick Loman works well, phenol:chloroform extraction](https://www.protocols.io/view/ultra-long-read-sequencing-protocol-for-rad004-mrxc57n) 
...
* DNA has always been difficult to get into solution (see right pic below)
...
These are Ruta's pulse field gels showing samples that were sequenced. Fresh tissue from A. xenica, F. nottii. Frozen tissue from F. catenatus and F. olivaceus.

<img src="img/four_gels.png" width="600px">
...
| *Fundulus olivaceus* | 4,962,626,713 (MinION)| 740,248 | 6,704 | 973,552 | 12726, n = 117202 | 
